...
CC_LIBS=-lpq -lcurl
CC_OBJS=env.o loki.o logger.o config.o audit.o email.o httputils.o sql.o login.o session.o mse.o main.o

cppserver: env.o loki.o logger.o config.o audit.o email.o httputils.o sql.o login.o session.o mse.o main.o
...
loki.o: src/loki.cpp src/loki.h
...
clean:
	rm env.o logger.o loki.o sql.o login.o session.o httputils.o mse.o email.o audit.o config.o main.o
